...
class NoteFragment : Fragment() {
    ...
    private lateinit var note:AppNote
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.btn_edit -> {
                    ...
                    //APP_ACTIVITY.navController.navigate(R.id.action_noteFragment_to_fragment_editing_note)
                println("Bundle NoteFragment = " + bundle)
                APP_ACTIVITY.navController.navigate(R.id.action_noteFragment_to_fragment_editing_note, bundle)
            }
        }
